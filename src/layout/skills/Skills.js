...
export const Skills = () => {
    ...
    return (
        <section id="skills" className={s.skillsBlock}>
            <Title text={SkillsData[locale].text} shadowText={SkillsData[locale].shadowText}/>

            <div className={s.skillsDescriptions}>
                {SkillsData[locale].description.map(elem => {
                    return (
            ...
            <div id="skillsFilterBtns" ref={skillsItemsRef}>
                <SkillsFilterBtns
                    menuItems={SkillsData[locale].skillsFilter}
